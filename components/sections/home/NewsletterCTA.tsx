  ...
  return (
    <Section id="newsletter" className="relative overflow-hidden w-full">
      ...
      <Container className="relative z-10">
        {/* Double-layered gradient border container */}
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: '-80px' }}
          className="p-[1px] rounded-2xl bg-gradient-to-r from-primary/30 via-border to-accent/30 max-w-3xl mx-auto shadow-modal"
        >
          <div className="glass-card p-8 md:p-12 rounded-[15px] bg-surface/90 backdrop-blur-md relative overflow-hidden text-center">
            ...
            <div className="flex flex-col items-center text-center max-w-xl mx-auto gap-4 relative z-10">
              {/* Tag */}
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 w-full mt-4">
                ...
                <Button
                  type="submit"
                  className="px-6 h-11 rounded-xl bg-primary text-background hover:opacity-90 font-semibold shadow-lg shadow-primary/20 flex items-center justify-center gap-2 cursor-pointer text-sm whitespace-nowrap transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 hover:shadow-primary/30"
                >
                  Subscribe
                </Button>
              </form>
